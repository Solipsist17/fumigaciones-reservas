...
public record RespuestaServicioDTO(Long id, Long idMaquinaria, Long idPlaga, Long idProducto, String nombre, Integer cantidadMaquinaria,
                                   Integer cantidadProducto, BigDecimal precioHora, String descripcion) {
    public RespuestaServicioDTO(Servicio servicio) {
